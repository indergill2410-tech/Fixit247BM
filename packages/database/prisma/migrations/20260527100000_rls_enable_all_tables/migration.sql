...
--
-- PHASE COUNT RECONCILIATION
-- --------------------------
-- Total tables: 57 (Phase 1: 11, Phase 2: 9, Phase 3: 21, Phase 4: 15, Phase 5: 1)
-- Early analysis drafts counted 23 Phase 3 tables. The final tally is 21 because
-- `notifications` and `notification_preferences` were re-classified to Phase 4
-- (profile/preference data with per-user ownership columns) rather than Phase 3
-- (pure transactional). The policy structure is unchanged — no policies are added
-- to either table at this stage.
--
-- APPLY ORDER
-- -----------
