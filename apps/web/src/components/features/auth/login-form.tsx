...
export function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-[480px] flex-col items-center justify-center bg-gray-900 p-16 text-white shrink-0">
        <div className="w-full max-w-sm text-center">
          {/* Logo */}
          <div className="mb-10 flex items-center justify-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500 text-gray-900 font-black text-lg">F</div>
            <span className="text-xl font-extrabold tracking-tight">FIXIT<span className="text-brand-500">247</span></span>
          </div>
          <h2 className="text-4xl font-black leading-tight tracking-tight mb-4">Fix anything.<br/><span className="text-brand-500">Anytime.</span></h2>
          <p className="text-white/60 text-sm leading-relaxed mb-10">Australia&apos;s #1 emergency trades platform. 8,400+ verified tradies ready right now.</p>
          <div className="flex justify-center gap-8">
            <div className="text-center"><div className="text-2xl font-black text-brand-500">94k</div><div className="text-xs text-white/50 mt-1">Jobs Done</div></div>
            <div className="w-px bg-white/10" />
            <div className="text-center"><div className="text-2xl font-black text-brand-500">4.9★</div><div className="text-xs text-white/50 mt-1">Avg Rating</div></div>
            <div className="w-px bg-white/10" />
            <div className="text-center"><div className="text-2xl font-black text-brand-500">12min</div><div className="text-xs text-white/50 mt-1">Response</div></div>
          </div>
        </div>
      </div>
      {/* Right panel — white form */}
      <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-16 xl:px-24 bg-white dark:bg-background">
                ...
                <>
                  ...
                  <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm-warm">
                    <div className="divide-y divide-border">
                      {DEMO_ACCOUNTS.filter(({ role }) => role !== 'SUPER_ADMIN').map(({ email, password, label, description, icon, badge, badgeColor }) => {
