...
export default function HomePage() {
  return (
    <main className="flex flex-col bg-background transition-colors duration-300">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-4 pb-16 pt-14 md:pb-24 md:pt-20 lg:pb-28 lg:pt-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_380px] lg:items-start xl:grid-cols-[1fr_400px]">
            ...
            <div className="flex flex-col animate-fade-up">
              ...
              {/* Main headline */}
              <h1 className="text-[3.25rem] font-black leading-[1.04] tracking-tighter text-foreground sm:text-[4rem] lg:text-[5rem] xl:text-[5.5rem]">
                Emergency tradie,<br />
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
                <Link
                  href="/emergency"
                  className="group inline-flex items-center justify-center gap-2.5 rounded-2xl bg-brand-500 px-7 py-4 text-sm font-bold text-gray-900 shadow-brand-md transition-all hover:bg-brand-400 hover:shadow-[0_0_50px_rgba(245,158,11,0.30)] active:scale-[0.98]"
                >
            ...
            <div className="lg:pt-2 animate-fade-up" style={{ animationDelay: '0.1s' }}>
              <RecentActivityFeed />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="relative overflow-hidden rounded-3xl border border-brand-500/20 bg-gradient-to-br from-brand-500/[0.08] via-brand-500/[0.04] to-transparent p-8 shadow-brand-md transition-all md:p-12 dark:shadow-none">
            ...
            <div className="relative grid gap-8 md:grid-cols-2 md:items-center">
              ...
              <div className="grid grid-cols-2 gap-3">
                {PLUS_FEATURES.map((f) => (
                  <div key={f.title} className="rounded-2xl border border-border/60 bg-card/60 p-4 shadow-sm-warm backdrop-blur-sm dark:border-white/[0.08] dark:bg-white/[0.03] dark:shadow-none">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-background/95 p-3 backdrop-blur-md sm:hidden">
        <Link
          href="/emergency"
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-brand-500 py-3.5 text-sm font-bold text-gray-900 transition-all active:scale-[0.98] shadow-brand-md"
        >
          <Phone size={15} />
