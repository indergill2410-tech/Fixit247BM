      ...
      <section className="relative overflow-hidden px-4 py-24 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-border bg-background-elevated px-4 py-1.5 text-sm font-medium text-brand-500">
            <FxIcon name="wrench" size={14} className="text-brand-500" /> Our story
          </span>
        ...
        <RevealSection>
          <div className="mx-auto max-w-xl">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <Link href="/register" className="rounded-xl bg-brand-500 px-7 py-3.5 text-sm font-bold text-gray-900 hover:bg-brand-400 transition-colors">
