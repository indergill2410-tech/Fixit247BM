      ...
      <section className="px-4 py-20 text-center">
        <div className="mx-auto max-w-2xl">
          <div className="mb-4 flex items-center justify-center gap-2">
            ...
            <span className="text-sm font-semibold uppercase tracking-widest text-brand-400">Available 24/7</span>
          </div>
          <h1 className="text-5xl font-extrabold leading-tight mb-4">
            Just <span className="text-brand-400">Talk.</span><br />We Handle the Rest.
          </h1>
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div key={title} className="rounded-2xl border border-white/8 bg-white/4 p-6 text-center">
