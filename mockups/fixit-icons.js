/**
 * Fixit247 Icon System — SVG sprite definitions
 * Usage: FX.icon('wrench') returns an SVG string
 */
const FX = {
  icons: {
    /* Brand */
    bolt: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>`,
    logo: `<svg viewBox="0 0 32 32" fill="none"><rect width="32" height="32" rx="8" fill="#F59E0B"/><polygon points="18 4 8 18 16 18 14 28 24 14 16 14 18 4" fill="#1a1208"/></svg>`,
    ...
    brush: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.06 11.9l8.07-8.06a2.85 2.85 0 1 1 4.03 4.03l-8.06 8.08"/><path d="M7.07 14.94c-1.66 0-3 1.35-3 3.02 0 1.33-2.5 1.52-2 2.02 1 1 2.99 2.02 5 2.02 2.2 0 4-1.8 4-4.04a3.01 3.01 0 0 0-4-2.86z"/></svg>`,
    ...
    clipboard: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="2" width="6" height="4" rx="1"/><path d="M8 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2h-2"/><path d="M12 11h4"/><path d="M12 16h4"/><path d="M8 11h.01"/><path d="M8 16h.01"/></svg>`,
    ...
    wifi: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M10.54 16a6 6 0 0 1 2.92 0"/><line x1="12" y1="20" x2="12.01" y2="20"/></svg>`,
  ...
  tradeIcon(trade) {
    const map = {
      plumbing: 'wrench', electrical: 'zap', cleaning: 'droplets',
      building: 'hammer', gardening: 'scissors', locksmith: 'lock',
      painting: 'brush', aircon: 'wind', tiling: 'ruler',
    };
    return this.icon(map[trade] || 'wrench');
  }
};
